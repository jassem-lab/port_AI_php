...
<div id="content" class="site-content">
    <div class="page-header dtable text-center header-transparent pheader-service-detail1">
        <div class="dcell">
            <div class="container">
                <h1 class="page-title">Design & Planning</h1>
            ...
            <div class="widget-area col-lg-3 col-md-12">
                <div class="widget widget_nav_menu">
                    <ul class="services-menu">
                        <li class="current-menu-item"><a href="servcies-detail-1.html"><span>01.</span> Design &
                                Planning</a></li>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="services-detail-content">
                    <div class="ot-heading ">
                        ...
                        <h2 class="main-heading">All Kinds of Buildings in Chematic or<br> Working Design</h2>
                    </div>
                    ...
                    <img src="https://via.placeholder.com/870x520.png" class="detail-img" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 text-center">
                            <div class="circle-progress tbottom" data-color="#939393" data-height="2" data-size="165"
                                ...
                                <div class="inner-bar" data-percent="85">
                                    <span><span class="percent">85%</span></span>
                                </div>
                                <h4>2d planning</h4>
                            </div>
