...
<div id="content" class="site-content">
    <div class="page-header dtable text-center header-transparent" style="background-image: url(./assets/images/pheader-portfolio.jpg) ">
        <div class="dcell">
            <div class="container">
                    ...
                    <div class="projects-grid pf_3_cols style-3 img-scale w-auto">
                        ...
                        <div class="project-item category-15">
                            <div class="projects-box">
                                ...
                                <div class="portfolio-info">
                                    <div class="portfolio-info-inner text-center">
                                        <h5><a class="title-link" href="portfolio-standar.html">Luxury Bathroom
                                                Interior</a></h5>
                        ...
                        <div class="project-item category-19">
                            <div class="projects-box">
                                ...
                                <div class="portfolio-info">
                                    <div class="portfolio-info-inner text-center">
                                        <h5><a class="title-link" href="portfolio-left.html">White Italian Villa</a>
                                        </h5>
